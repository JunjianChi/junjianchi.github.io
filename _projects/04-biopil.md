...
<p class="lang-en">This was my <a href="https://www.youtube.com/watch?v=-s3cfciB_M4" target="_blank" rel="noopener">2023 IEEE CASS Student Design Competition</a> entry, participated in Year 2.</p>
...
<div class="project-gallery">
  <figure>
    <img src="{{ '/images/projects/bio-sensor-pill/IMG_2931.PNG' | relative_url }}" alt="Capsule 3D render" loading="lazy" />
  ...
  <figure>
    <img src="{{ '/images/projects/bio-sensor-pill/d05024f2cff9b5b18d6cd435f9ba8f97.PNG' | relative_url }}" alt="Flex-rigid PCB layout" loading="lazy" />
...
<video width="100%" controls muted playsinline style="border-radius: 6px; border: 1px solid var(--border-subtle);">
  <source src="{{ '/images/projects/bio-sensor-pill/1.mp4' | relative_url }}" type="video/mp4">
</video>
